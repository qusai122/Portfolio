...
AddMenu(viewModal1, CardModal, 'nav-toggle', 1);
AddMenu(viewModal2, CardModal, 'nav-toggle', 2);
AddMenu(viewModal3, CardModal, 'nav-toggle', 3);
AddMenu(viewModal4, CardModal, 'nav-toggle', 4);
RemoveMenu(CardModal, CardModal, 'nav-toggle');
